package com.jun.my_mango.backup.util;
...
//        if (backup(host, userName, password, backupFolderPath, fileName, database)){
//            System.out.println("备份成功");
//        }
//
//
///*        System.out.println("开始还原");
//        String restoreFilePath = "D:/dev/mango.sql";
