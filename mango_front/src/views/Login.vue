...
export default {
    ...
    methods: {
        login() {
            this.loading = true;
            let userInfo = {account: this.loginForm.account,password: this.loginForm.password,captcha: this.loginForm.captcha,captchaId: this.loginForm.captchaId};
        ...
        refreshCaptcha() {
            ...
            this.$api.login.captcha().then(res => {
                if (res.msg != null){
                    ...
                    this.loginForm.src = res.data.captchaBase64;
