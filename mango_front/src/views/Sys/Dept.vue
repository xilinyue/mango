<template>
    <div class="page-container">
        <!-- 工具栏 -->
        <div class="toobar" style="float: left;padding-top: 10px;padding-left: 15px">
            <el-form :inline="true" :model="filters" :size="size">
                <el-form-item>
                    <el-input v-model="filters.name" placeholder="名称"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button icon="fa fa-search" :label="$t('action.search')"  perms="sys:dept:view" type="primary" @click="findTreeData(null)"></el-button>
                </el-form-item>
                <el-form-item>
                    <el-button icon="fa fa-plus" :label="$t('action.search')" perms="sys:dept:add" type="primary" @click="handleAdd"></el-button>
                </el-form-item>
            </el-form>
        </div>
        <!-- 表格树内容 -->
        <el-table :data="tableTreeData" stripe size="mini" style="width: 100%"
            ...
            <el-table-column prop="parentName" header-align="center" align="center" width="120" label="上级机构"></el-table-column>
