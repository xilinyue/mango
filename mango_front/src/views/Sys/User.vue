    ...
    export default {
        ...
        methods: {
            ...
            exportUserExcelFile() {
                ...
                // this.pageRequest.params = [{name:'name', value:this.filters.name}];
                this.pageRequest.params = {'name': this.filters.name};
                this.$api.user.exportUserExcelFile(this.pageRequest).then(response => {
                    ...
                    reader.onload = (e) => {      //调用API onload  文件读取成功时触发
                        ...
                        a.download = "download_user" + Date.parse(new Date()) + '.xlsx';   //设置格式
            ...
            // 批量删除
            handleDelete(data) {
                this.$api.user.batchDelete(data.params).then(
